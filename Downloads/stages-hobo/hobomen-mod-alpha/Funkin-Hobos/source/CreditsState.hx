...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
	    ['Vs Hobomen Mod Devs'],
		['Kazoo_Jake', 'jake', ' Former Charter, Artist', 'https://gamebanana.com/members/1869086', 0xFFF9F108],
		['prod.xonthebeat', 'prod', 'Musician, The guy that had the whole idea of the mod.', 'https://gamebanana.com/members/1946384', 0xFF811B00],
		[''],
		['Psych Engine Team'],
