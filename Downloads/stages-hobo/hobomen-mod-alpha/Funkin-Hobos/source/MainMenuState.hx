...
{
	public static var psychEngineVersion:String = 'Vs Hobomen V0.1.2'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "the version is:" + psychEngineVersion, 12);
